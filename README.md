...
**What is a _merge conflict_?**: A **merge conflict** 1111 0000 occurs when changes are made to the same part of the same file on two different branches. You usually find out about conflicts in a pull request so let's start by creating one.

### :keyboard: Activity: Create a pull request

1. Open a new browser tab, and work on the steps in your 8888 second tab while you read the instructions in this tab.
